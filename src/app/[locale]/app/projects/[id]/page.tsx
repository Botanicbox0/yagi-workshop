        ...
        {activeTab === "brief" && (
          <BriefTab
            ...
            labels={{
              ...
              production_spec: {
                eyebrow: tDetail("brief_tab.production_spec.eyebrow"),
                title: tDetail("brief_tab.production_spec.title"),
                description: tDetail("brief_tab.production_spec.description"),
                summary_label: tDetail("brief_tab.production_spec.summary_label"),
                not_set: tDetail("brief_tab.production_spec.not_set"),
                mood_label: tDetail("brief_tab.production_spec.mood_label"),
                mood_helper: tDetail("brief_tab.production_spec.mood_helper"),
                mood_free_placeholder: tDetail(
                  "brief_tab.production_spec.mood_free_placeholder",
                ),
                ratio_label: tDetail("brief_tab.production_spec.ratio_label"),
                ratio_custom_placeholder: tDetail(
                  "brief_tab.production_spec.ratio_custom_placeholder",
                ),
                channels_label: tDetail(
                  "brief_tab.production_spec.channels_label",
                ),
                channels_helper: tDetail(
                  "brief_tab.production_spec.channels_helper",
                ),
                save: tDetail("brief_tab.production_spec.save"),
                saving: tDetail("brief_tab.production_spec.saving"),
                saved: tDetail("brief_tab.production_spec.saved"),
                save_error: tDetail("brief_tab.production_spec.save_error"),
                read_only: tDetail("brief_tab.production_spec.read_only"),
                mood_options: {
