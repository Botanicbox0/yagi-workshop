	...
	extend: {
		...
		colors: {
			...
			brand: {
				...
				pressed: 'var(--ds-red-pressed)',
				soft:    'var(--ds-red-soft)',
				ink:     'var(--ds-red-ink)',
				on:      'var(--ds-red-on-fill)',
				deep:    'var(--ds-red-deep)',
			},
			// v1.3 functional amber — internal/team-only marking (not a brand color).
			internal: {
				DEFAULT: 'var(--ds-internal)',
				soft:    'var(--ds-internal-soft)',
				ink:     'var(--ds-internal-ink)',
				on:      'var(--ds-internal-on-fill)',
			},
			gold: {
				DEFAULT: 'var(--ds-gold)',
