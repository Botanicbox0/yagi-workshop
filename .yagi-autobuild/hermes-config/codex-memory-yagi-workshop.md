...
- dc4d0b0 ops: legacy retrieval CPU mode for ComfyUI 공존 (TASK 29, superseded by Chroma)
...
## Active decisions
- PRODUCT-MASTER is a living document. Current truth lives in the body; major changes go to Decision Log.
